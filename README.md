...
| `scrollview-update-interval` | `0` | Minimum interval for scroll-driven content updates.  Zero updates synchronously; a positive value coalesces thumb/sign updates per window while keeping existing indicators anchored to their screen rows. |
